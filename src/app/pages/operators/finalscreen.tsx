...
function FinalScreen(){
    return(
        <div className="h-screen relative flex flex-col items-center justify-center text-white">
            <div className="relative bg-orangeBG w-[55%] h-[70%] flex flex-col justify-center items-center rounded-xl pb-3 pt-5">
                <div className='pb-10'>
                ...
                <div className='flex justify-between pt-8 w-[75%]'>
                    <div className='w-[50%] text-right'>
                        <button className='py-2 shadow-lg w-48 font-bold text-xl rounded-3xl bg-darkOrange border border-gray-700'>Save Score</button>
                    </div>
