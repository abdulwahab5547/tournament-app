    ...
    return(
        <div className="flex items-center justify-between gap-5">
            ...
            <div className="bg-white border-gray-500 py-1 flex justify-center items-center px-7 w-12 rounded-2xl shadow-xl">
                <p className="text-lightYellow text-xl font-bold py-2">00</p>
            </div>
            ...
            <div className="bg-white border-gray-500 py-1 flex justify-center items-center px-8 w-12 rounded-2xl shadow-xl">
                <p className="text-lightYellow text-xl font-bold py-2">000</p>
            </div>
        </div>
    )
}
